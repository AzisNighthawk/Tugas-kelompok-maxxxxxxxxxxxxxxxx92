<?php
echo "<h1>Demonstrasi Pengkondisian PHP</h1>\n\n";
// 1. Hanya 1 kondisi positif
$kondisi_bunga = 'layu';
echo "<h2>1. 1 Kondisi Positif (Bunga)</h2>";
...
$pr = 'tidak dikerjakan';
echo "<h2>2. 1 Kondisi Negatif (Pekerjaan Rumah)</h2>";
...
// 4. Lebih dari 2 Kondisi (7 Kondisi Kuota Internet)
$kuota_mb = 50; // Contoh: ubah nilai untuk test
echo "<h2>4. 7 Kondisi (Kuota Internet)</h2>";
...
// 5. Kondisi Bersarang (Jenis Jaringan + Kuota)
$jenis_jaringan = 'cepat';
$kuota_nested = 2500; // MB
